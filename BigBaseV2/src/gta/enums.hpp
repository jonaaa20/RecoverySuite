...
enum eExplosionTag : std::uint32_t
{
	//EXP_TAG_DONTCARE = -1,
	EXP_TAG_GRENADE,
...
{
	eFrameFlagAimZoomIn = 1 << 2,
	eFrameFlagDisableAimCam = 1 << 7,
	eFrameFlagExplosiveAmmo = 1 << 11,
	eFrameFlagFireAmmo = 1 << 12,
	eFrameFlagExplosiveMelee = 1 << 13,
	eFrameFlagSuperJump = 1 << 14,
	eFrameFlagDisablePlayerVehicleRewards = 1 << 21,
	eFrameFlagJumpForward = 1 << 29
};
...
{
	Tunables = 262145,
	TunablesUnlockReset = 2590899,
	OrbitalRefundMoney = 1694984,
	DespawnBypass = 4269479,
	CurrentMPChar = 1312763,

	IdleTimer = 1377236,
	IdleTimer_Offset_1 = 1165,
	IdleTimer_Offset_2 = 1149,
	IdleTimerUNK1 = 1312910,
	IdleTimerUNK2 = 2464816,

	MessageID_1 = 4265558,
	MessageID_2 = 4265552,

	UnlockExclusiveContent = 150692,
	BunkerGlobal = 2515666,
	CollectableGlobal = 2516075,
	FestiveAtomizer = 101851,// !!
	SpecialCargo_1 = 1678147,
	SpecialCargo_2 = 1677993,
	CurrentHangarSaleCD = 2516993,

	GetXPValue = 292403,

	TransitionState = 1312830,
	SessionType = 1312854,
	InitSession = 1312443,
	SessionUNK1 = 30969,
	SessionUNK2 = 1312482,
	...
	SessionUNK4 = 1312829,
	SessionSCTV = 2463732,
	SessionBlockBypass = 2452015,
	SessionBlockBypass_Offset = 742,
	SessionBlockBypass_Statement = 1312855,
};

enum eScriptLocals : std::uint32_t
{
	// TBA
};